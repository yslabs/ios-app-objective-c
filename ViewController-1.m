...
- (void)viewDidLoad {
    ...
    UIImage * kepishLogoImg = [UIImage imageNamed:@"dashlogo_kepish"];
    UIImageView * kepishLogo = [[UIImageView alloc]init];
    [kepishLogo setFrame:CGRectMake(self.view.frame.size.width/2-kepishLogoImg.size.width/2,self.view.frame.size.height/2-kepishLogoImg.size.height*4+kepishLogoImg.size.height*9/10,kepishLogoImg.size.width, kepishLogoImg.size.height)];
    [kepishLogo setImage:kepishLogoImg];
