...
- (void)viewDidLoad {
    ...
    // for setting the background color/image
    ...
    // for adding the image
    UIImage * hashTagLogoImage = [UIImage imageNamed:@"logo_hashTag"];
    UIImageView * hashTagLogo = [[UIImageView alloc]init];
    [hashTagLogo setFrame:CGRectMake(self.view.frame.size.width/2-hashTagLogoImage.size.width/2,hashTagLogoImage.size.height-hashTagLogoImage.size.height/3,hashTagLogoImage.size.width, hashTagLogoImage.size.height)];
    [hashTagLogo setImage:hashTagLogoImage];
   ...
   // for adding the button
    ...
    //to call the method for adding the label
    CGFloat hashTagFeeLabelwidth = 170;
    UILabel* hashTagFeeLabel = [self addLabelWithFrame:CGRectMake(LeagueFeeView.frame.size.width/2-hashTagFeeLabelwidth/2+50/5,LeagueFeeView.frame.size.height/2-50/2,hashTagFeeLabelwidth,50) text:@"League Fee" font:[UIFont fontWithName:@"Roboto-Bold" size:28] textColor:[UIColor colorWithRed:58.0/255.0 green:124.0/255.0 blue:180.0/255.0 alpha:1.0] textAlign:NSTextAlignmentLeft];
    [LeagueFeeView addSubview:hashTagFeeLabel];
